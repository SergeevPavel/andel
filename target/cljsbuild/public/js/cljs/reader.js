...
var len__8911__auto___18075 = arguments.length;
var i__8912__auto___18076 = (0);
while(true){
if((i__8912__auto___18076 < len__8911__auto___18075)){
args__8918__auto__.push((arguments[i__8912__auto___18076]));

var G__18077 = (i__8912__auto___18076 + (1));
i__8912__auto___18076 = G__18077;
continue;
} else {
}
break;
...
cljs.reader.reader_error.cljs$lang$applyTo = (function (seq18073){
var G__18074 = cljs.core.first(seq18073);
var seq18073__$1 = cljs.core.next(seq18073);
return cljs.reader.reader_error.cljs$core$IFn$_invoke$arity$variadic(G__18074,seq18073__$1);
});
...
var G__18078 = (function (){
sb.append(ch);

return sb;
})()
;
var G__18079 = cljs.reader.read_char(rdr);
sb = G__18078;
ch = G__18079;
continue;
}
...
var a = (cljs.core.truth_((groups[(3)]))?[(groups[(3)]),(10)]:(cljs.core.truth_((groups[(4)]))?[(groups[(4)]),(16)]:(cljs.core.truth_((groups[(5)]))?[(groups[(5)]),(8)]:(cljs.core.truth_((groups[(6)]))?[(groups[(7)]),(function (){var G__18080 = (groups[(6)]);
var G__18081 = (10);
return parseInt(G__18080,G__18081);
})()]:[null,null]
))));
var n = (a[(0)]);
var radix = (a[(1)]);
...
var G__18082 = cljs.reader.read_char(rdr);
ch = G__18082;
continue;
} else {
return ch;
...
var G__18083 = (((mret === rdr))?a:(function (){
a.push(mret);
...
if((i > (0))){
var G__18085 = (i - (1));
var G__18086 = r.cljs$core$ICollection$_conj$arity$2(null,(arr[(i - (1))]));
i = G__18085;
r = G__18086;
continue;
} else {
...
;
var G__18088 = cljs.reader.read_char(reader);
buffer = G__18087;
ch = G__18088;
continue;
}
...
if(("\\" === ch)){
var G__18089 = (function (){
buffer.append(cljs.reader.escape_char(buffer,reader));

return buffer;
})()
;
var G__18090 = cljs.reader.read_char(reader);
buffer = G__18089;
ch = G__18090;
continue;
} else {
...
var G__18091 = (function (){
buffer.append(ch);

return buffer;
})()
;
var G__18092 = cljs.reader.read_char(reader);
buffer = G__18091;
ch = G__18092;
continue;
...
var G__18095 = (function (){var G__18093 = buffer;
G__18093.append(nch);

return G__18093;
})();
var G__18096 = cljs.reader.read_char(reader);
buffer = G__18095;
ch = G__18096;
continue;
}
...
var G__18097 = (function (){var G__18094 = buffer;
G__18094.append(ch);

return G__18094;
})();
var G__18098 = cljs.reader.read_char(reader);
buffer = G__18097;
ch = G__18098;
continue;
...
var G__18100 = reader;
var G__18101 = eof_is_error;
var G__18102 = sentinel;
var G__18103 = is_recursive;
reader = G__18100;
eof_is_error = G__18101;
sentinel = G__18102;
is_recursive = G__18103;
continue;
} else {
if(cljs.reader.comment_prefix_QMARK_(ch)){
var G__18104 = (cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2 ? cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2(reader,ch) : cljs.reader.read_comment.call(null,reader,ch));
var G__18105 = eof_is_error;
var G__18106 = sentinel;
var G__18107 = is_recursive;
reader = G__18104;
eof_is_error = G__18105;
sentinel = G__18106;
is_recursive = G__18107;
continue;
} else {
...
if((res === reader)){
var G__18108 = reader;
var G__18109 = eof_is_error;
var G__18110 = sentinel;
var G__18111 = is_recursive;
reader = G__18108;
eof_is_error = G__18109;
sentinel = G__18110;
is_recursive = G__18111;
continue;
} else {
return res;
}
...
var vec__18113 = cljs.core.re_matches(cljs.reader.timestamp_regex,s);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18113,(0),null);
var years = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18113,(1),null);
var months = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18113,(2),null);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18113,(3),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18113,(4),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18113,(5),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18113,(6),null);
var fraction = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18113,(7),null);
var offset_sign = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18113,(8),null);
var offset_hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18113,(9),null);
var offset_minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18113,(10),null);
var v = vec__18113;
if(cljs.core.not(v)){
...
return new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [years__$1,cljs.reader.check((1),months__$1,(12),"timestamp month field must be in range 1..12"),cljs.reader.check((1),days__$1,(function (){var G__18116 = months__$1;
var G__18117 = cljs.reader.leap_year_QMARK_(years__$1);
return (cljs.reader.days_in_month.cljs$core$IFn$_invoke$arity$2 ? cljs.reader.days_in_month.cljs$core$IFn$_invoke$arity$2(G__18116,G__18117) : cljs.reader.days_in_month.call(null,G__18116,G__18117));
...
if(cljs.core.truth_(temp__5276__auto__)){
var vec__18118 = temp__5276__auto__;
var years = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18118,(0),null);
var months = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18118,(1),null);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18118,(2),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18118,(3),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18118,(4),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18118,(5),null);
var ms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18118,(6),null);
var offset = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18118,(7),null);
...
var arr = [];
var seq__18121_18137 = cljs.core.seq(form);
var chunk__18122_18138 = null;
var count__18123_18139 = (0);
var i__18124_18140 = (0);
while(true){
if((i__18124_18140 < count__18123_18139)){
var x_18141 = chunk__18122_18138.cljs$core$IIndexed$_nth$arity$2(null,i__18124_18140);
arr.push(x_18141);

var G__18142 = seq__18121_18137;
var G__18143 = chunk__18122_18138;
var G__18144 = count__18123_18139;
var G__18145 = (i__18124_18140 + (1));
seq__18121_18137 = G__18142;
chunk__18122_18138 = G__18143;
count__18123_18139 = G__18144;
i__18124_18140 = G__18145;
continue;
} else {
var temp__5278__auto___18146 = cljs.core.seq(seq__18121_18137);
if(temp__5278__auto___18146){
var seq__18121_18147__$1 = temp__5278__auto___18146;
if(cljs.core.chunked_seq_QMARK_(seq__18121_18147__$1)){
var c__8590__auto___18148 = cljs.core.chunk_first(seq__18121_18147__$1);
var G__18149 = cljs.core.chunk_rest(seq__18121_18147__$1);
var G__18150 = c__8590__auto___18148;
var G__18151 = cljs.core.count(c__8590__auto___18148);
var G__18152 = (0);
seq__18121_18137 = G__18149;
chunk__18122_18138 = G__18150;
count__18123_18139 = G__18151;
i__18124_18140 = G__18152;
continue;
} else {
var x_18153 = cljs.core.first(seq__18121_18147__$1);
arr.push(x_18153);

var G__18154 = cljs.core.next(seq__18121_18147__$1);
var G__18155 = null;
var G__18156 = (0);
var G__18157 = (0);
seq__18121_18137 = G__18154;
chunk__18122_18138 = G__18155;
count__18123_18139 = G__18156;
i__18124_18140 = G__18157;
continue;
}
} else {
}
...
var obj = {};
var seq__18127_18158 = cljs.core.seq(form);
var chunk__18128_18159 = null;
var count__18129_18160 = (0);
var i__18130_18161 = (0);
while(true){
if((i__18130_18161 < count__18129_18160)){
var vec__18131_18162 = chunk__18128_18159.cljs$core$IIndexed$_nth$arity$2(null,i__18130_18161);
var k_18163 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18131_18162,(0),null);
var v_18164 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18131_18162,(1),null);
(obj[cljs.core.name(k_18163)] = v_18164);

var G__18165 = seq__18127_18158;
var G__18166 = chunk__18128_18159;
var G__18167 = count__18129_18160;
var G__18168 = (i__18130_18161 + (1));
seq__18127_18158 = G__18165;
chunk__18128_18159 = G__18166;
count__18129_18160 = G__18167;
i__18130_18161 = G__18168;
continue;
} else {
var temp__5278__auto___18169 = cljs.core.seq(seq__18127_18158);
if(temp__5278__auto___18169){
var seq__18127_18170__$1 = temp__5278__auto___18169;
if(cljs.core.chunked_seq_QMARK_(seq__18127_18170__$1)){
var c__8590__auto___18171 = cljs.core.chunk_first(seq__18127_18170__$1);
var G__18172 = cljs.core.chunk_rest(seq__18127_18170__$1);
var G__18173 = c__8590__auto___18171;
var G__18174 = cljs.core.count(c__8590__auto___18171);
var G__18175 = (0);
seq__18127_18158 = G__18172;
chunk__18128_18159 = G__18173;
count__18129_18160 = G__18174;
i__18130_18161 = G__18175;
continue;
} else {
var vec__18134_18176 = cljs.core.first(seq__18127_18170__$1);
var k_18177 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18134_18176,(0),null);
var v_18178 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18134_18176,(1),null);
(obj[cljs.core.name(k_18177)] = v_18178);

var G__18179 = cljs.core.next(seq__18127_18170__$1);
var G__18180 = null;
var G__18181 = (0);
var G__18182 = (0);
seq__18127_18158 = G__18179;
chunk__18128_18159 = G__18180;
count__18129_18160 = G__18181;
i__18130_18161 = G__18182;
continue;
}
} else {
}
...
var G__18183 = cljs.reader.read(rdr,true,null,false);
return (pfn.cljs$core$IFn$_invoke$arity$1 ? pfn.cljs$core$IFn$_invoke$arity$1(G__18183) : pfn.call(null,G__18183));
} else {
if(cljs.core.truth_(dfn)){
var G__18184 = tag;
var G__18185 = cljs.reader.read(rdr,true,null,false);
return (dfn.cljs$core$IFn$_invoke$arity$2 ? dfn.cljs$core$IFn$_invoke$arity$2(G__18184,G__18185) : dfn.call(null,G__18184,G__18185));
} else {
