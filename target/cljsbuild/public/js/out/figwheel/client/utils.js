...
var or__41064__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj66110 = {"detail":data};
return obj66110;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__41052__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__41052__auto__)){
var and__41052__auto____$1 = (window["CustomEvent"]);
...
var f = (function (){var pred__66117 = cljs.core._EQ_;
var expr__66118 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__66117.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__66118))){
return ((function (pred__66117,expr__66118){
return (function (p1__66111_SHARP_){
return console.warn(p1__66111_SHARP_);
});
;})(pred__66117,expr__66118))
} else {
if(cljs.core.truth_(pred__66117.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__66118))){
return ((function (pred__66117,expr__66118){
return (function (p1__66112_SHARP_){
return console.debug(p1__66112_SHARP_);
});
;})(pred__66117,expr__66118))
} else {
if(cljs.core.truth_(pred__66117.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__66118))){
return ((function (pred__66117,expr__66118){
return (function (p1__66113_SHARP_){
return console.error(p1__66113_SHARP_);
});
;})(pred__66117,expr__66118))
} else {
return ((function (pred__66117,expr__66118){
return (function (p1__66114_SHARP_){
return console.log(p1__66114_SHARP_);
});
;})(pred__66117,expr__66118))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__66121){
...
var opts = map__66122__$1;
var eval_fn = cljs.core.get.call(null,map__66122__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__66124_SHARP_);
});})(new_def))
);
...
return (function (p__66125){
var vec__66126 = p__66125;
var ky = cljs.core.nth.call(null,vec__66126,(0),null);
var v = cljs.core.nth.call(null,vec__66126,(1),null);
...
if(cljs.core.truth_((function (){var and__41052__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1504289162667