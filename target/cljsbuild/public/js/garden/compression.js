 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__19128){
var vec__19129 = p__19128;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19129,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19129,(1),null);
return ((function (vec__19129,tag,re){
return (function (s){
...
var len__8911__auto___19134 = arguments.length;
var i__8912__auto___19135 = (0);
while(true){
if((i__8912__auto___19135 < len__8911__auto___19134)){
args__8918__auto__.push((arguments[i__8912__auto___19135]));

var G__19136 = (i__8912__auto___19135 + (1));
i__8912__auto___19135 = G__19136;
continue;
} else {
}
break;
...
return (p1__19132_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__19132_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__19132_SHARP_.call(null,s));
});})(fs))
,fs);
});
;})(fs))
...
garden.compression.tokenizer.cljs$lang$applyTo = (function (seq19133){
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq19133));
});
...
var map__19137 = temp__5276__auto__;
...
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19137__$1,cljs.core.cst$kw$tag);
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19137__$1,cljs.core.cst$kw$chunk);
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19137__$1,cljs.core.cst$kw$size);
var G__19140 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__19141 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s2),cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__19139 = tag;
